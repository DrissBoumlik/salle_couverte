...
{
    public partial class Ajoutez_Modifier_une_Categorie : Form
    {
        public Ajoutez_Modifier_une_Categorie()
        {
            InitializeComponent();
        }   
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("update Categorie set cat=@cat where id_cat=@id", cn);
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                cmd = new SqlCommand("insert into Categorie values(@cat)", cn);
                cmd.Parameters.AddWithValue("@cat", textBox1.Text);
